...
{
    public class OrderDataContract : IDataContractSurrogate
    {
        ...
        object GetShipperToSerialize(Shipper shipper)
        {
            return new Shipper
            {
                Phone = shipper.Phone,
        ...
        object GetOrderDetailToSerialize(Order_Detail orderDetail)
        {
        ...
        object GetEmployeeToSerialize(Employee employee)
        {
            return new Employee
            {
        ...
        object GetCustomerToSerialize(Customer customer)
        {
            return new Customer
            {
        ...
        Order GetOrderToSerialize(Order order)
        {
            return new Order
            {
