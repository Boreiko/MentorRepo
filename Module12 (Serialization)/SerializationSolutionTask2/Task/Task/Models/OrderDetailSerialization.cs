...
{
    public class OrderDetailSerialization : ISerializationSurrogate
    {
        public void GetObjectData(object obj, SerializationInfo info, StreamingContext context)
        {
            var orderDetail = (Order_Detail)obj;
            if (context.Context is CustomContext serializationContext && serializationContext.SerializationType == typeof(Order_Detail))
            {
